    ...
    <Sheet open={isOpen}>
      ...
      >
        ...
        <div className="px-5">
          ...
          <p className="text-regular-12 text-gray-250">상세한 필터로 원하는 스터디를 찾아보세요!</p>
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div className="flex flex-col">
              <label htmlFor="manufacturer" className="text-gray-600 text-bold-16">
                검색어
              </label>
              <input
                type="manufacturer"
                ...
                className="mt-2 rounded-md border border-gray-200 p-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
              />
            </div>
            <div className="flex flex-col">
              <label htmlFor="date" className="text-gray-600 text-bold-16">
                스터디 시작 일자
              </label>
              <input
                type="date"
            ...
            <div className="flex flex-col">
              <label htmlFor="status" className="text-gray-600 text-bold-16">
                카테고리
              </label>
              <select
                id="status"
